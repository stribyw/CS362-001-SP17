//Obtained from: https://www.cs.utexas.edu/~scottm/cs307/javacode/codeSamples/ArrayExamples.java
//Mike Scott
...
{	public static void main(String[] args)
	...
	//bug introduced was that the || below was &&
	{	assert list != null || newSize >= 0 : "failed precondition";
		...
		//inserted bug below by commenting out the line
		//list = temp;
	}
	...
	{	assert list != null : "failed precondition";
		//bug introduced was that i = 2 was i = 0
